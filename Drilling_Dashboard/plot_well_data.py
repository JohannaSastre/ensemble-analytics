...
x_rounded = x.round(2)  # Round the 'x' column to 2 decimal places
...
with st.sidebar:
    ...
    selected = option_menu(
        menu_title="Menu",
        options=["About", "Upload Data", "Pre-Drill Phase","While-Drill Phase", "Post-Drill Phase"],
        icons=["info-circle", "cloud-upload", "graph-up","graph-up","graph-up"],
        menu_icon="cast",
        default_index=0,
    )
...
porosity_options = {
    ...
    "xAxis": {
        "type": "category",
        "data": x_rounded.tolist(),  # Convert to list
    ...
    "series": [{
        "name": "Porosity",
        "type": "line",
        "data": PHIT.tolist(),  # Convert to list
        "itemStyle": {"color": "red"}
    }],
}
...
water_saturation_options = {
    ...
    "series": [{
        "name": "Water Saturation",
        "type": "line",
        "data": Sw.tolist(),  # Convert to list
...
pressure_options = {
    ...
    "series": [{
        "name": "Pressure",
        "type": "line",
        "data": Pe.tolist(),  # Convert to list
...
thickness_options = {
    ...
    "series": [{
        "name": "Thickness",
        "type": "line",
        "data": Thickness.tolist(),  # Convert to list
