...
if selected == "Sales Conversions":
    ...
    ########### setup widgets
        ...
        if selected_category == 'Wells':
            ...
            for region in selected_identifiers:
                df_base = data_dict_base['Wells'][region][selected_property].apply(pd.to_numeric, errors='coerce')  
                df_project = data_dict_project['Wells'][region][selected_property].apply(pd.to_numeric, errors='coerce')  
